import React__default, { memo, useRef, useEffect, createElement } from 'react';
...
const Multislider = React__default.memo(function Multislider({ size, max, min, smoothing, step, values, candycane, onChange = NO_OP, onReady = NO_OP }) {
    let multislider = React__default.useRef(null);
    let elementId = React__default.useRef(`nexus-ui-multislider-${getId()}`);
    ...
    return React__default.createElement("div", { id: elementId.current });
});
